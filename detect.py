...
from utils.general import (LOGGER, Profile, check_file, check_img_size, check_imshow, check_requirements, colorstr, cv2,
                           increment_path,increment_path1, non_max_suppression, print_args, scale_boxes, strip_optimizer, xyxy2xywh)
...
def run(
        ...
        project='static/finalimage',  # save results to project/name
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        # Inference
        with dt[1]:
            visualize = increment_path1(save_dir / Path(path).stem, mkdir=True) if visualize else False
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        label = None if hide_labels else (names[c] if hide_conf else f'{names[c]} | {conf:.2f}|{c}')
...
def parse_opt():
    ...
    parser.add_argument('--conf-thres', type=int, default=0.55, help='confidence threshold')
    ...
    parser.add_argument('--project', default='static/finalimage', help='save results to project/name')
